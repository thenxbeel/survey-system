// lib/mockSurveys.ts
//
// TYPES & CONSTANTS ONLY — no mock data.
//
// All survey data now comes from /api/surveys (Prisma-backed).
// This file is kept ONLY to preserve the SurveyRecord / SurveyStatus types
// and the TOUCHPOINTS / BRANCHES constants that the existing UI components
// depend on. The mockSurveys array has been removed.
